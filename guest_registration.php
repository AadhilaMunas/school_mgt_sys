...
<html>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-horizontal">
                                        <input type="hidden" id="gest_hid">
                                        <div class="form-group ">                                        
                                            <label class="col-lg-4 control-label custom-label">Reservation No :</label>
                                            <div class="col-lg-6">
                                                <div class="input-group col-lg-12">
                                                    <input type="text"  id="res_no" class="form-control res_no" placeholder="Guest Origin" disabled>
                                                    <div class="input-group-addon"><i class="fa fa-archive"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">                                        
                                            <label class="col-lg-4 control-label custom-label">Origin: </label>           
                                            <div class="col-lg-6">
                                                <div class="input-group col-lg-12">
                                                    <input type="text"  id="guest_origin" class="form-control guest_origin" placeholder="Guest Origin" disabled>
                                                    <div class="input-group-addon"><i class="fa fa-archive"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">                                        
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group col-lg-12">
                                                    <input type="text"  id="guest_title" class="form-control guest_title" placeholder="Guest title" disabled>
                                                    <div class="input-group-addon"><i class="fa fa-archive"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">                                        
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group col-lg-12">
                                                    <input type="text"  id="no_guest" class="form-control no_guest" placeholder="No of Guest" >
                                                    <div class="input-group-addon"><i class="fa fa-archive"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">                                        
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group col-lg-12">
                                                    <input type="text"  id="no_rooms" class="form-control no_rooms" placeholder="No of Rooms" >
                                                    <div class="input-group-addon"><i class="fa fa-archive"></i></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="search">
                                ...
                                <form onsubmit="return false;">
                                    <input type="search" value="" id="search_reg_id" placeholder="Type Student Index Number here" autocomplete="off" />
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#guest_reset', function () {
            clear_guest_reg();
        });
