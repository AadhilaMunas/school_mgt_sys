                ...
                <div class="row">                                 
                    <div class="col-md-12">
                        <div class="page-header cutom-header">
                            <h3>Guest selected Laundry & Pressing Bills </h3>
                        </div>
                        <div class="row">
                            <!-- FORM START -->
                            <div class="col-md-4">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group ">                                        
                                        <label class="col-lg-4 control-label custom-label">Reservation :</label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group ">                                        
                                        <label class="col-lg-4 control-label custom-label">Laundry Bill No :</label>
                                        <div class="col-lg-6">
                                            <select class="sundry_bill_comboBox" onkeyup="set_focus_next(event, '#room_no')"></select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label custom-label">Guest Name :</label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label custom-label">Laundry Item <font color="red">*</font> :</label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" id="sun_price" class="form-control custom-text1" onkeypress="return isNumberKey(event);" placeholder="Rs.00.00" disabled="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
