                            ...
                            <div class="col-md-6">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group ">                                        
                                        <label class="col-lg-4 control-label custom-label">Type <font color="red">*</font> :</label>
                                        <div class="col-lg-6">
                                            <select class="Type_ComboBox"></select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label custom-label">Type Name <font color="red">*</font> :</label>
                                        <div class="col-lg-6">
                                            <input type="text" id="syscode_name" class="form-control custom-text1" onkeyup="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label custom-label">Type Code <font color="red"></font> :</label>
                                        <div class="col-lg-6">
                                            <input type="text" id="syscode_code" class="form-control custom-text1" onkeyup="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label custom-label">Remarks :</label>
                                        <div class="col-lg-6">
                                            <textarea type="text" id="syscode_remarks" class="form-control custom-text1" onkeyup=""> </textarea>                      
                                        </div>
                                    </div>
                                    <div class="form-group">
