<div class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
    ...
    <div class="row">
        <div class="navbar-header">            
            <a class="navbar-brand" href="dashboard.php" style="padding-left: 25px;"><strong>School Management System</strong></a>
             <ul class="nav navbar-nav navbar-right">                
                <li><a href="#">Welcome <?php echo $_SESSION['htl_user_name'] ?></a></li>  
            </ul>
        </div>
    </div>
    <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active" style="padding-left: 10px;">
                        <a href="dashboard.php" class="btn btn-custom-save"><i class="fa fa-lg fa-home"></i>&nbsp;&nbsp;Home</a>
                    </li> 
                    ...
                    $quary = "SELECT
                          ...
                          WHERE in_usrprvlg.usrID = '{$_SESSION['htl_user_id']}' AND in_sysprvlg.usrPrnt = 0";
...
//              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">' . $aa['usrPrvMnuName'] . ' <span class="caret"></span></a></li>';
                            ...
                            $quw = "SELECT
                                ...
                                INNER JOIN in_usrprvlg ON in_usrprvlg.usrPrvCode = in_sysprvlg.prvCode
                                WHERE
                                in_usrprvlg.usrID = '{$_SESSION['htl_user_id']}'
