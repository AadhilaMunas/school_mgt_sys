                            ...
                            <div class="col-md-6">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label custom-label">Basic: <font color="red">*</font> :</label>
                                        <div class="col-lg-6">
                                            <div class="input-group col-lg-12">
                                                <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                                <input type="text" id="b_maincat" class="form-control b_maincat" placeholder="Add Basic">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel" style="">
                                    <div class="panel-heading panel-custom">
                                        <h3 class="panel-title title-custom">Basic Details</h3>
